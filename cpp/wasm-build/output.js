...
// WebSlam
/** @suppress {undefinedVars, duplicate} @this{Object} */function WebSlam() {
  this.ptr = _emscripten_bind_WebSlam_WebSlam_0();
  getCache(WebSlam)[this.ptr] = this;
};;
WebSlam.prototype = Object.create(WrapperObject.prototype);
WebSlam.prototype.constructor = WebSlam;
WebSlam.prototype.__class__ = WebSlam;
WebSlam.__cache__ = {};
Module['WebSlam'] = WebSlam;

WebSlam.prototype['processFrameAndDrawFeatures'] = WebSlam.prototype.processFrameAndDrawFeatures = /** @suppress {undefinedVars, duplicate} @this{Object} */function(image, w, h, c) {
  var self = this.ptr;
  ensureCache.prepare();
